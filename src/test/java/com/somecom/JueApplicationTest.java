...
/**
 * Basic integration tests for {@link }.
 *
 * @author Brock Mills
...
@Import(JueApplicationTest.Ports.class)
public class JueApplicationTest {
    ...
    @Autowired
    private TaskApplyRepository repository;

    @Test
    public void testApplyTask() {
        TaskApply taskApply = new TaskApply();
        taskApply.setUserId(1);
        taskApply.setTask(Task.of(1));
        TaskApply save = repository.save(taskApply);
