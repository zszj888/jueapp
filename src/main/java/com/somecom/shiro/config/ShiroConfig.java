...
//
//import com.somecom.shiro.AuthRealm;
//import com.somecom.shiro.UserAuthFilter;
//import com.somecom.shiro.remember.RememberMeManager;
...
////        filterMap.put("/admin/noAuth", "anon");
...
//        // 未授权错误页面
////        shiroFilterFactoryBean.setUnauthorizedUrl("/admin/noAuth");
//
...
//        sessionManager.setSessionValidationInterval(70 * 1000);
