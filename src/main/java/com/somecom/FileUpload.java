...
import com.somecom.enums.UploadResultEnum;
...
public class FileUpload {
     ...
     * 生成随机且唯一的文件名
     */
    public static String genFileName2(String originalFilename) {
     ...
     *
     * @param multipartFile MultipartFile对象
     * @param upload        SysFile
     */
    public static void transferTo(MultipartFile multipartFile, SysFile upload) {
        InputStream inputStream = null;
        try {
            Files.copy(inputStream = multipartFile.getInputStream(), getDestFile(upload).toPath(),
     ...
     * @param upload        SysFile
     */
    public static void transferToOld(MultipartFile multipartFile, SysFile upload) throws IOException, NoSuchAlgorithmException {
