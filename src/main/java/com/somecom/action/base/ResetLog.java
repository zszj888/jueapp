package com.somecom.action.base;
...
public class ResetLog {
    ...
    public boolean isResultVo() {
        return retValue instanceof SysResultVo;
    }
    ...
    public boolean isSuccess() {
        return retValue instanceof SysResultVo &&
                ((SysResultVo) retValue).getCode().equals(ResultEnum.SUCCESS.getCode());
    }
    ...
    public boolean isSuccessRecord() {
        return record = retValue instanceof SysResultVo &&
                ((SysResultVo) retValue).getCode().equals(ResultEnum.SUCCESS.getCode());
    }
