...
import com.somecom.action.model.ActionModel;
import com.somecom.action.model.BusinessMethod;
import com.somecom.action.model.BusinessType;
...
public class ActionLogAop {
    ...
    @Pointcut("@annotation(com.somecom.annotation.ActionLog)")
    ...
    public Object recordLog(ProceedingJoinPoint point) throws Throwable {
        ...
        // 封装日志实例对象
        com.somecom.entity.ActionLog actionLog = new com.somecom.entity.ActionLog();
