...
import com.somecom.repository.MenuRepository;
...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public List<Menu> getListBySortOk() {
        ...
        return menuRepository.findAllByStatus(sort, SystemDataStatusEnum.OK.getCode());
    }
    ...
    public Boolean updateStatus(SystemDataStatusEnum systemDataStatusEnum, List<Long> ids) {
        ...
        treeMenus.forEach(menu -> {
            ...
            // 更新关联的所有菜单状态
            menu.setStatus(systemDataStatusEnum.getCode());
        });
