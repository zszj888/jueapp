...
//
//import com.somecom.entity.Dept;
...
//import com.somecom.repository.DeptRepository;
...
//        return deptRepository.findByPidsLikeAndStatus("%[" + id + "]%", SystemDataStatusEnum.OK.getCode());
//    }
//
//    /**
//     * 保存部门管理
